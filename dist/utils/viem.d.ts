...
declare const relayerClient: WalletClient;
declare const publicClient: {
    ...
    simulateContract: <const abi extends import("viem").Abi | readonly unknown[], functionName extends import("viem").ContractFunctionName<abi, "nonpayable" | "payable">, const args_1 extends import("viem").ContractFunctionArgs<abi, "nonpayable" | "payable", functionName>, chainOverride extends import("viem").Chain | undefined, accountOverride extends import("viem").Account | import("viem").Address | undefined = undefined>(args: SimulateContractParameters<abi, functionName, args_1, {
        blockExplorers: {
            readonly default: {
                readonly name: "Morph Holesky Explorer";
                readonly url: "https://explorer-holesky.morphl2.io";
...
declare const executeContractFunction: ({ functionName, args, }: {
    functionName: string;
    args: any[];
}) => Promise<never>;
